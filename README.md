About pytest-textual-snapshot-feedstock
=======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-textual-snapshot-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-textual-snapshot-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-textual-snapshot
# for installing globally
pixi global install pytest-textual-snapshot
```
...
It is possible to list all of the versions of `pytest-textual-snapshot` available on your platform:
...
```
pixi search pytest-textual-snapshot --channel conda-forge
```
